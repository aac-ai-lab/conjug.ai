...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[node distance=8mm]
    ...
    \node[dec, below left=14mm and 23mm of t0] (t1) {Tem \emph{ontem}?};
    \node[dec, below right=14mm and 23mm of t0] (p1) {1.\textsuperscript{o} token vou/vai…?};
    \node[proc, below=14mm of t1, font=\small] (tp) {Pretérito perfeito};
    \node[proc, below=14mm of p1, font=\small] (tf) {Futuro do presente};
    \node[proc, below=31mm of t0, font=\small] (tn) {Presente do indicativo};
    \node[proc, below=9mm of tn, font=\small] (tn0) {Presente};
